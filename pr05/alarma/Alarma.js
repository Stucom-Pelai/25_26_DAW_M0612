export class Alarma {
    ...
    generaObjecteHTML(){
        ...
        h2.innerText= this.titol;
        div.appendChild(h2);
        div.appendChild(document.createElement("DIV").innerText="hora alarma: ${this.hora_completa}");
        div.appendChild(document.createElement("DIV").innerText="musica: ${this.musica}");
        div.appendChild(document.createElement("DIV").innerText="activa:${this.activa}");
        const but_act = document.createElement("BUTTON");
        but_act.innerText= "ACTIVA";
        but_act.addEventListener("click",activaAlarma);
        div.appendChild(but_act);
        
        const but_des = document.createElement("BUTTON");
        but_des.innerText= "DESACTIVA";
        but_des.addEventListener("click",desactivaAlarma);
        div.appendChild(but_des)
        return div;
    }
}
