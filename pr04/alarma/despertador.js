...
function checkHoraAlarma(){
    ...
    let hora_alarma= alarma.hora_completa;
...
let alarma;
function creaAlarma(hora,minut,segon){
    alarma = new Alarma("exemple Alarma",hora,minut,segon,"musica exxemple",false);
    document.getElementById("div_hora_alarma").innerHTML = alarma.generaCodiHTML();
}
